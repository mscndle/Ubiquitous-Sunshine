...
package com.mcondle.sunshine.wear;
...
//            mYOffset = resources.getDimension(R.dimen.digital_y_offset);
            ...
            mTextTimeSecondsPaint = createTextPaint(Color.WHITE);
            mTextDatePaint = createTextPaint(resources.getColor(R.color.disabled_text_light));
            mTextDateAmbientPaint = createTextPaint(Color.WHITE);
            mTextTempHighPaint = createTextPaint(Color.WHITE);
            mTextTempLowPaint = createTextPaint(resources.getColor(R.color.disabled_text_light));
...
//                mTime.setToNow();
                ...
                // update time using the calendar object
                mCalendar.setTimeZone(TimeZone.getDefault());
                mCalendar.setTimeInMillis(System.currentTimeMillis());
